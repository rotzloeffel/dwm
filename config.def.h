...
static const char col_gray1[]       = "#1e2129";
...
static const char *clipmenucmd[]  = { "clipmenu", "-p", "clipmenu:", "-fn", "CaskaydiaMono Nerd Font:size=10", "-nb", "#2e3440", "-nf", "#81a1c1", "-sb", "#4c566a", "-sf", "#e5e9f0", NULL };
